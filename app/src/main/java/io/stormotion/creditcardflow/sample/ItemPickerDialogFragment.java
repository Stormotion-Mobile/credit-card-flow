...
public class ItemPickerDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(title)
                ...
                .setSingleChoiceItems(itemTitles, selectedIndex, (dialog, which) -> selectedIndex = which);

        return builder.create();
    }

    public ItemPickerDialogFragment setListener(OnItemSelectedListener listener) {
